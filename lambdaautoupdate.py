...
INGRESS_PORTS = { 'Http' : 58081, 'Https': 443 }
...
def update_security_groups(new_ranges):
    ...
    print ('Found ' + str(len(global_http_group)) + ' CloudFront-IP-List-Global-HTTP HttpSecurityGroups to update')
    print ('Found ' + str(len(global_https_group)) + ' CloudFront-IP-List-Global-HTTPS HttpsSecurityGroups to update')
    print ('Found ' + str(len(region_http_group)) + ' CloudFront-IP-List-Region-HTTP HttpSecurityGroups to update')
    print ('Found ' + str(len(region_https_group)) + ' CloudFront-IP-List-Region-HTTPS HttpsSecurityGroups to update')
    ...
    result.append('Updated ' + str(global_http_updated) + ' of ' + str(len(global_http_group)) + ' CloudFront-IP-List-Global-HTTP HttpSecurityGroups')
    result.append('Updated ' + str(global_https_updated) + ' of ' + str(len(global_https_group)) + ' CloudFront-IP-List-Global-HTTPS HttpsSecurityGroups')
    result.append('Updated ' + str(region_http_updated) + ' of ' + str(len(region_http_group)) + ' CloudFront-IP-List-Region-HTTP HttpSecurityGroups')
    result.append('Updated ' + str(region_https_updated) + ' of ' + str(len(region_https_group)) + ' CloudFront-IP-List-Region-HTTPS HttpsSecurityGroups')
...
def get_security_groups_for_update(client, security_group_tag):
    ...
    for key, value in security_group_tag.items():
        print ('loop =================')
        print ('key = ' + key)
        print (security_group_tag.items())
